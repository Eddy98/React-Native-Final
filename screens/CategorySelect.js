  ...
  return (
    <ScrollView style={styles.container}>
      <TouchableOpacity
        ...
        onPress={() => {
          props.route.params('Top Headlines')
        }}
      >
      ...
      <TouchableOpacity
        style={styles.categoryContainer}
        onPress={() => {
          props.route.params('Entertainment')
        }}
      >
        <Text style={[styles.category, { color: 'yellow' }]}>
          Entertainment
        </Text>
      </TouchableOpacity>
      <TouchableOpacity
